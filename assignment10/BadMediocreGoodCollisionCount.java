 ...
 */
public class BadMediocreGoodCollisionCount
{
...
//             goodHashTable = new QuadProbeHashTable(n, new GoodHashFunctor());
            ...
            badHashTable = new ChainingHashTable(INIT_CAPACITY, new BadHashFunctor());
            mediocreHashTable = new ChainingHashTable(INIT_CAPACITY, new MediocreHashFunctor());
...
//             goodHashTableTime);
            System.out.println(n + "\t" + goodHashTableTime);
            n *= 2;
        }
        // ************************************************************************************************************************//
