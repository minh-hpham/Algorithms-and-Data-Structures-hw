...
public class CheckRandomNumberGenerator
{
	...
	public static void main(String[] args)
	{
		...
		RandomNumberGenerator j_rand = new MyRandomNumberGenerator();
		...
		//a-1 = multiple of the prime factors of m
		// if m%4 == 0, (a-1)%4 == 0
		//c is relatively prime with m
		 System.out.println("---------------------------------------");
		 System.out.println ("Testing Better Random Number Generator");
		 j_rand = new MyRandomNumberGenerator(); 
		 j_rand.setConstants(56000, 71807);
		 check_rand = new CheckRandomNumberGenerator(); 
		 check_rand.check_random(j_rand, 234);
		 
//		 SaltShaker saltShaker = new SaltShaker(); j_rand.setSeed(uid);
//		 System.err.println("\nSalt: " + saltShaker.getSalt(j_rand));
