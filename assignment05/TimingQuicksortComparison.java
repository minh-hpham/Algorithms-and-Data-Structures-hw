...
/**
 * Class to time the quicksort method in SortUtil-- changing what order the unsorted array is in
 * 
 * @author Hannah Potter and Minh Pham
 */
public class TimingQuicksortComparison {
	/**
	 * Test to time the quicksort method on an ArrayList of Integers. Test run changing which case of
